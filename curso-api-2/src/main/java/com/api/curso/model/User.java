...
public class User implements UserDetails, Serializable {
	...
	@Column(name = "user_name", unique = true)// não pode ser repitido
	...
	@ManyToMany(fetch = FetchType.EAGER)//criando a tabela do meio user_permission
