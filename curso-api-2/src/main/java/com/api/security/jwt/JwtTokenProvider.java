...
//import com.api.curso.exceptions.InvalidJwtAuthenticationException;
...
//		Date validityRefreshToken = new Date(now.getTime() + (validityInMilliseconds * 3));//validityInMilliseconds== 1 hora , logo *3 = 3 horas
//		return JWT.create()
//				.withClaim("roles", roles)
//				.withIssuedAt(now)
...
//		//bearerToken="Bearer" + token , preciso descartar o Bearer que vem na String
...
//		DecodedJWT decodedJWT = decodedToken(token);
//		try {
//			// se for expirado antes de agora retorna falso
